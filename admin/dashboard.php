    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="?module=gejala" class="nav-link">
              <i class="fab fa-adversal"></i>
              <p>Gejala</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?module=rule_base" class="nav-link">
          ...
          <li class="nav-item">
            <a href="?module=pakar" class="nav-link">
              <i class="fas fa-address-book"></i>
              <p>Pakar</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?module=pasien" class="nav-link">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                          <div class="inner">
                            <?php    
                              $gejala=mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM gejala"));
                            ?>
                          ...
                          <a href="?module=gejala" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                      </div>
                      <!-- ./col -->
                      <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                          ...
                          <a href="?module=petani" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                      </div>
                      <!-- ./col -->
                      <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-red">
                          <div class="inner">
                            <?php    
                              $konsultasi=mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM konsultasi"));
                            ?>
                          ...
                          <a href="?module=konsultasi" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                      </div>
                      <!-- ./col -->
                    </div>
                    <!-- TABLE: LATEST ORDERS -->
                          <div class="card">
                            ...
                            <div class="card-body p-0">
                              <div class="table-responsive">
                                <table class="table m-0">
                                  ...
                                  <tbody>
                                    <?php  
                                    $sql=mysqli_query($koneksi, "SELECT * FROM konsultasi, pasien, penyakit WHERE konsultasi.kode_pasien=pasien.kode_pasien AND konsultasi.hasil=penyakit.kode_penyakit ORDER BY konsultasi.kode_konsultasi DESC LIMIT 5 ");
                                    $no = 1;
                            ...
                            <div class="card-footer clearfix">
                              ...
                              <a href="?module=konsultasi" class="btn btn-sm btn-secondary float-right">Lihat Semua</a>
                            </div>
                            <!-- /.card-footer -->
                          </div>
                          <!-- /.card -->
