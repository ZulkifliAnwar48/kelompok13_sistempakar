					...
					<div class="well col-lg-12">
							<div class="panel panel-primary">
								...
								echo "<div class=col-lg-12>&nbsp</div>
									...
									<a href=\"?module=rule_base\"><button  class=\"btn btn-sm btn-danger\"><i class=\"glyphicon glyphicon-save\"></i> Batal</button></a>
								</form>
								</div>
								</div>
							</div>
						...
						<tr>
							<td>
								<div class="btn-group">
					  				...
					  				$result = mysqli_query($koneksi, $query);
					  				while($baris=mysqli_fetch_array($result)){
					  					echo "<li>&nbsp;&nbsp;&nbsp;&nbsp;<a href=?module=rule_base&kode_penyakit=$baris[kode_penyakit]>$baris[nama_penyakit]</a></li>";	
					  				}
					  				?>
					    			</ul>
								</div>
