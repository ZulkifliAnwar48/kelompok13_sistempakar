			...
			<tbody>
				...
				?>	
						<tr>	
							...
							<td>
           						<a href="cetak_pa.php?id=<?php echo $data['kode_pasien'] ?>" target="_blank" class="btn btn-info">Print</a>
           					</td>
						</tr>
				...
				<a href="cetak_konsultasi.php"><button class="btn btn-primary">Cetak Data</button></h3>
				</div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
