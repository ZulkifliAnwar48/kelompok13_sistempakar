<?php  
$query = mysqli_query($koneksi, "SELECT * FROM petani WHERE kode_petani='$_GET[kode_petani]'");
      ...
      <div class="row">
        <div class="col-12">
			...
			if(isset($_POST['add'])){
				...
				$update = mysqli_query($koneksi, "UPDATE petani SET username='$username',  
																				nama='$nama', 
																				password='$password',
																				jenis_kelamin='$jenis_kelamin',
																				alamat='$alamat',
																				telp='$telp'
																				WHERE kode_petani='$kode_petani'") or die(mysqli_error($koneksi));
				if($update){
                    ...
                    <div class="card-tools">
                      ...
                      <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button>
						...
						<form class="form-horizontal" action="" method="post">
							...
							<input type="hidden" name="kode_petani" value="<?php echo $row['kode_petani'];?>" class="form-control" placeholder="Username" required readonly>
